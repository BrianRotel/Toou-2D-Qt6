    ...
    TRectangle {
        ...
        Column {
            ...
            Repeater {
                ...
                model: [{
                        "label": "Home",
                        "icon": TAwesomeType.FA_home,
                        "uri": "qrc:/Home.qml"
                    }, {
                        "label": "Control",
                        "icon": TAwesomeType.FA_rocket,
                        "uri": "qrc:/Control.qml"
                    }, {
                        "label": "Demo",
                        "icon": TAwesomeType.FA_codiepie,
                        "uri": "qrc:/Demo.qml"
                    }, {
                        "label": "Awesome",
                        "icon": TAwesomeType.FA_font_awesome,
                        "uri": "qrc:/Awesome.qml"
                    }, {
                        "label": "Api docs",
                        "icon": TAwesomeType.FA_book,
                        "uri": "http://oss.toou.net/docs/2d/index.html"
                    }, {
                        "label": "Github",
                        "icon": TAwesomeType.FA_github_alt,
                        "uri": "https://github.com/ShowFL/Toou-2D"
                    }]
