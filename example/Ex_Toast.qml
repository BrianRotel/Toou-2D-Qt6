...
Column {
        ...
        Row {
            ...
            TSVGIcon {
                ...
                source: {
                    switch ("const_info") {
                    case "const_success":
                        return "qrc:/net.toou.2d/resource/svg/success.svg"
                    case "const_warning":
                        return "qrc:/net.toou.2d/resource/svg/warning.svg"
                    case "const_info":
                        return "qrc:/net.toou.2d/resource/svg/info.svg"
                    case "const_error":
                        return "qrc:/net.toou.2d/resource/svg/error.svg"
                    }
                    return "#FFFFFF"
                }
    ...
    Row {
        ...
        TButton {
            ...
            label.color: "#46A0FC"
            onClicked: {
                TToast.showSuccess("Welcome to Toou2D", TTimePreset.LongTime4s,
        ...
        TButton {
            ...
            label.color: "#46A0FC"
            onClicked: TToast.showWarning("Welcome to Toou2D",
        ...
        TButton {
            ...
            label.color: "#46A0FC"
            onClicked: TToast.showInfo("Welcome to Toou2D",
                                       TTimePreset.ShortTime2s)
        }
        ...
        TButton {
            ...
            label.color: "#46A0FC"
            onClicked: TToast.showError("Welcome to Toou2D",
                                        TTimePreset.ShortTime2s)
        }
    }
